 ...
 * 
 * @author Vhati
 * @author kartoFlane -- use AlphanumComparator for non-equal string comparison
 */
public class ComparableVersion implements Comparable<ComparableVersion> {
	...
	public int compareTo(ComparableVersion other) {
		...
		if (suffix != null && other.getSuffix() != null) {
			...
			int cmp = comparator.compare(suffix, other.getSuffix());
			if (cmp != 0)
				return cmp;
		}
		...
		if (comment != null && other.getComment() != null) {
			Comparator<String> comparator = new AlphanumComparator();
			int cmp = comparator.compare(comment, other.getComment());
			if (cmp != 0)
				return cmp;
		}
