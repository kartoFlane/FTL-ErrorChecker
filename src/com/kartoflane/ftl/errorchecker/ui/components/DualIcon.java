 ...
 * @author Darryl Burke -- http://tips4java.wordpress.com/2009/03/22/dual-icon/
 */
public class DualIcon implements Icon, SwingConstants {
	 ...
	 * horizontal and vertical positioning and default gap. <CODE>icon2</CODE> is positioned to the right of <CODE>icon1</CODE> with a 4 pixel gap, and the vertical centers of the icons are aligned.
	 * 
	 * @param icon1
	 *            the first icon
	 * @param icon2
	 ...
	 *            One of the following values:
	 *            <ul>
	 *            <li>{@code SwingConstants.TOP} <li>{@code SwingConstants.CENTER} <li>{@code SwingConstants.BOTTOM}
	 *            </ul>
	 *            <P>
	 * @param iconIconGap
	 *            the gap between the icons in pizels, ignored if the
	 *            horizontalPosition and verticalPosition are both <CODE>SwingConstants.CENTER</CODE>.
	 */
	public DualIcon(Icon icon1, Icon icon2,
	...
	/**
	 * Gets the height of the the bounding rectangle of this <CODE>DualIcon</CODE>.
	 * 
