...
/**
 * 
 * @author Darryl Burke -- http://tips4java.wordpress.com/2009/03/25/toggle-button-icons/
 *
 */
public class CheckBoxIcon extends ToggleButtonIcon {
	 ...
	 *            the horizontal position of the custom icon
	 ...
	 *            the vertical position of the custom icon
